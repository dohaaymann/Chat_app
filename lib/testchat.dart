...
Widget ChatWidget(var currentUser, var messageList, var chatController,  var user,var getmessage, var name, var photo,) {
  ...
  return ChatView(
      ...
      appBar: ChatViewAppBar(
        frienfprofile:(){
          Get.to(()=>friend_profile(name,user,"busy",photo));
          print("object");
        },
