...
class DarkTheme extends AppTheme {
  DarkTheme({
    ...
    Color appBarColor = const Color(0xff44404D),
    Color backArrowColor = Colors.white,
    Color backgroundColor = const Color(0xff1E1E2A),
    Color backgroundhome = const Color(0xff1E1E2A),
    Color backgroundColorr = const Color(0xff1E1E2A),
    Color replyDialogColor = const Color(0xff91c9ff),
    Color buttonColor = const Color(0xff1E1E2A),
    Color linkPreviewOutgoingChatColor = const Color(0xff1E1E2A),
    Color linkPreviewIncomingChatColor = const Color(0xff564FF4),
    ...
    Color textFieldBackgroundColor = const Color(0xff44404D),
    Color outgoingChatBubbleColor = const Color(0xff564FF4),
    Color inComingChatBubbleColor = const Color(0xff7B7794),
    Color reactionPopupColor = const Color(0xff7B7794),
    Color replyPopupColor = const Color(0xff7B7794),
    ...
    Color repliedMessageColor = const Color(0xff91c9ff),
    Color closeIconColor = Colors.white,
    Color shareIconBackgroundColor = const Color(0xff7B7794),
    Color sendButtonColor = Colors.white,
    Color cameraIconColor = Colors.white,
    Color galleryIconColor = Colors.white,
    Color recorderIconColor = Colors.white,
    Color stopIconColor = const Color(0xff7B7794),
    Color replyMessageColor = Colors.black,
    Color appBarTitleTextStyle = Colors.white,
    Color messageReactionBackGroundColor = const Color(0xff7B7794),
    Color messageReactionBorderColor = const Color(0xff1E1E2A),
    Color verticalBarColor = const Color(0xff7B7794),
    ...
    Color waveformBackgroundColor = const Color(0xff7B7794),
    ...
    textFieldBackgroundColor: textFieldBackgroundColor,
          ...
          appBarColor: appBarColor,TextColor: TextColor,
          appBarTitleTextStyle: appBarTitleTextStyle,
          backArrowColor: backArrowColor,backgroundhome:backgroundhome,
...
class LightTheme extends AppTheme {
  LightTheme({
    // Color flashingCircleDarkColor = const Color(0xff6A53A1),
    Color flashingCircleDarkColor = const Color(0xff6A53A1),
    Color TextColor = Colors.black,
    Color flashingCircleBrightColor = const Color(0xff7B7794),
    TextStyle incomingChatLinkTitleStyle = const TextStyle(color: Colors.black),
    ...
    Color backgroundhome = Colors.white,
    Color backArrowColor = const Color(0xff6A53A1),
    Color backgroundColor = const Color(0xffeeeeee),
    Color backgroundColorr =const Color(0xff7B7794),
    Color replyDialogColor = const Color(0xff7B7794),
    Color buttonColor= const Color(0xff6A53A1),

    Color linkPreviewOutgoingChatColor = const Color(0xff7B7794),
    ...
    Color verticalBarColor = const Color(0xff6A53A1),
    ...
    Color replyMicIconColor = Colors.black,
          ...
          replyDialogColor: replyDialogColor,
          backgroundColor: backgroundColor,
          appBarColor: appBarColor,backgroundhome:backgroundhome,
          appBarTitleTextStyle: appBarTitleTextStyle,
          backArrowColor: backArrowColor,
          chatHeaderColor: chatHeaderColor,TextColor: TextColor,
          inComingChatBubbleColor: inComingChatBubbleColor,
          inComingChatBubbleTextColor: inComingChatBubbleTextColor,
          messageReactionBackGroundColor: messageReactionBackGroundColor,
          messageReactionBorderColor: messageReactionBorderColor,
